...
CREATE TABLE `henna` (
  ...
  `symbol_name` VARCHAR(15) DEFAULT NULL,
  `dye_id` SMALLINT(4) UNSIGNED NOT NULL,
  `dye_amount` TINYINT(2) UNSIGNED NOT NULL DEFAULT '10',
  `price` MEDIUMINT(6) UNSIGNED NOT NULL DEFAULT '1',
  `stat_INT` TINYINT(2) NOT NULL,
  `stat_STR` TINYINT(2) NOT NULL,
  `stat_CON` TINYINT(2) NOT NULL,
  `stat_MEM` TINYINT(2) NOT NULL,
