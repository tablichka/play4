...
/**
 * @author rage
 * @date 05.08.2010 16:18:47
 */
public class i_seven_arrows extends i_p_attack
{
	private final long[] _delays;

	public i_seven_arrows(EffectTemplate template)
	{
		super(template);
	...
	{
		private final i_seven_arrows _effect;
		...
		public CastTask(i_seven_arrows effect, L2Character cha, GArray<Env> targets, int ss, boolean counter)
		{
			_effect = effect;
