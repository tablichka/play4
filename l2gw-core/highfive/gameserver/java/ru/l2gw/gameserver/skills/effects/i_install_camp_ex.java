...
/**
 * @author: rage
 * @date: 10.07.2010 14:00:09
 */
public class i_install_camp_ex extends i_effect
{
	public i_install_camp_ex(EffectTemplate template)
	{
		super(template);
	}
	...
	public void doEffect(L2Character cha, GArray<Env> targets, int ss, boolean counter)
	{
		...
		try
		{
			flag.addStatFunc(FuncFactory.createFunc("Mul", Stats.MAX_HP, 0x50, 5000, flag));
