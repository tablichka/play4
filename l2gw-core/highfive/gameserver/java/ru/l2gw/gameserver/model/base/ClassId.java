...
public enum ClassId
{
	...
	darkAvenger(6, false, Race.human, knight, null, 3), //mod--
	...
	necromancer(13, true, Race.human, wizard, null, 3), //mod--
	warlock(14, true, Race.human, wizard, null, 3),
	cleric(15, true, Race.human, mage, null, 2),
	bishop(16, true, Race.human, cleric, null, 3), //mod--
	...
	overlord(51, true, Race.orc, orcShaman, null, 3), //mod--
	...
	public final ClassId getFirstChild()
	{
		for(ClassId classId : values())
		{
			if(this == classId._parent || this == classId._parent2)
				return classId;
		}
		return this;
	}
