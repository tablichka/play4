package ru.l2gw.extensions.listeners.engine;
...
import ru.l2gw.extensions.listeners.events.DefaultPropertyChangeEvent;
...
public class DefaultListenerEngine<T> implements ListenerEngine<T>
{
	...
	public MethodInvocationResult fireMethodInvoked(MethodEvent event)
	{
		...
		if(mappedMethodInvokedListeners == null)
			return event.getInvocationResult();
	...
	@Override
	public MethodInvocationResult fireMethodInvoked(String methodName, T source, Object[] args)
	{
		return fireMethodInvoked(new DefaultMethodInvokeEvent(methodName, source, args));
	}
}
