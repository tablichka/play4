...
public class ExProperties extends Properties
{
	...
	public int getIntProperty(String name, int def)
	{
		...
		if(s != null && s.startsWith("0x"))
			return getIntHexProperty(name, def);
		
		return s == null ? def : Integer.parseInt(s.trim());
	}

	public int getIntHexProperty(String name, int def)
	{
		String s = getProperty(name);
		if(s == null)
			return def;
	...
	public String[] getArrayProperty(String name, String def)
	{
		String s = getProperty(name);
		if(s == null)
			s = def;
		...
		return ArrayUtils.toStringArray(s);
	}


	public int[] getIntArrayProperty(String name, String def)
	{
		String s = getProperty(name);
		if(s == null)
			s = def;
		...
		return ArrayUtils.toIntArray(s);
	}

	public long[] getLongArrayProperty(String name, String def)
	{
		String s = getProperty(name);
		if(s == null)
			s = def;
		...
		return ArrayUtils.toLongArray(s);
	}

	public double[] getDoubleArrayProperty(String name, String def)
	{
		String s = getProperty(name);
		if(s == null)
			s = def;
		...
		return ArrayUtils.toDoubleArray(s);
	}

	public float[] getFloatArrayProperty(String name, String def)
	{
		String s = getProperty(name);
		if(s == null)
			s = def;
		...
		return ArrayUtils.toFloatArray(s);
	}
}