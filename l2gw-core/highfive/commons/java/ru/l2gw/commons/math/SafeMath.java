...
public class SafeMath
{
	 ...
	 */
	private static final long MAX_COUNT = 99999999999L;
	...
	public static long safeMulLong(long a, long b) throws ArithmeticException
	{
		...
		if(isOverflowLong(ret))
			throw new ArithmeticException(String.format("Overflow: %d*%d=%d (%s)", a, b, ret.longValue(), ret.toString()));
	...
	public static long safeMulLong(double a, double b) throws ArithmeticException
	{
		BigDecimal ret = BigDecimal.valueOf(a).multiply(BigDecimal.valueOf(b));
		if(isOverflowLong(ret))
			throw new ArithmeticException(String.format("Overflow: %d*%d=%d (%s)", a, b, ret.longValue(), ret.toString()));
	...
	public static long safeDivLong(long a, long b) throws ArithmeticException
	{
		if(a == Long.MIN_VALUE && b == -1)
		  throw new ArithmeticException(String.format("Overflow: %d/%d=%d", a, b, a/b));
		return a/b;
	}
	...
	{
		BigInteger ret = BigInteger.valueOf(a).add(BigInteger.valueOf(b));
		return isOverflowLong(ret) || ret.compareTo(BigInteger.valueOf(MAX_COUNT)) > 0 ? MAX_COUNT : ret.longValue();
	}
	...
	static final BigInteger BigInteger_Long_MAX_VALUE = BigInteger.valueOf(Long.MAX_VALUE);
	static final BigInteger BigInteger_Long_MIN_VALUE = BigInteger.valueOf(Long.MIN_VALUE);

	public static boolean isOverflowLong(BigInteger val)
	{
		return val.compareTo(BigInteger_Long_MAX_VALUE) == 1 || val.compareTo(BigInteger_Long_MIN_VALUE) == -1;
	}

	static final BigDecimal BigDecimal_Long_MAX_VALUE = BigDecimal.valueOf(Long.MAX_VALUE);
	static final BigDecimal BigDecimal_Long_MIN_VALUE = BigDecimal.valueOf(Long.MIN_VALUE);

	public static boolean isOverflowLong(BigDecimal val)
	{
		return val.compareTo(BigDecimal_Long_MAX_VALUE) == 1 || val.compareTo(BigDecimal_Long_MIN_VALUE) == -1;
	}
	...
	public static int safeMulInt(int a, int b) throws ArithmeticException
	{
		...
		if(isOverflowInt(ret))
			throw new ArithmeticException(String.format("Overflow: %d*%d=%d (%d)", a, b, (int) ret, ret));
		return (int) ret;
	}
	...
	public static short safeMulShort(int a, int b) throws ArithmeticException
	{
		...
		if(isOverflowShort(ret))
			throw new ArithmeticException(String.format("Overflow: %d*%d=%d (%d)", a, b, (short) ret, ret));
		return (short) ret;
	}
	...
	public static byte safeMulByte(int a, int b) throws ArithmeticException
	{
		...
		if(isOverflowByte(ret))
			throw new ArithmeticException(String.format("Overflow: %d*%d=%d (%d)", a, b, (byte) ret, ret));
		return (byte) ret;
	}
