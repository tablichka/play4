...
/**
 * @author rage
 * @date 06.10.2010 22:37:37
 */
public class PailakaDevilsLegacy extends Instance
{
	private ZoneListener zoneListener = new ZoneListener();

	public PailakaDevilsLegacy(InstanceTemplate template, int rId)
	{
		super(template, rId);
	}
	...
	public void onPlayerExit(L2Player player)
	{
		...
		else
		{
			...
			if(player.getPet() != null && (player.getPet().getNpcId() == 14916 || player.getPet().getNpcId() == 14917))
