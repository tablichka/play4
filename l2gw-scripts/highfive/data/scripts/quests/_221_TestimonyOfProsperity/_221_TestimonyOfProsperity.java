package quests._221_TestimonyOfProsperity;
...
public class _221_TestimonyOfProsperity extends Quest
{
	...
	private static final int[][] DROPLIST_COND = {
			{1, 0, MandragoraSprout, BrightsList, MandragoraPetal, 20, 60, 1},
			{1, 0, MandragoraSapling, BrightsList, MandragoraPetal, 20, 80, 1},
			{1, 0, MandragoraBlossom, BrightsList, MandragoraPetal, 20, 100, 1},
			{1, 0, MandragoraSprout2, BrightsList, MandragoraPetal, 20, 30, 1},
			{1, 0, GiantCrimsonAnt, BrightsList, CrimsonMoss, 10, 100, 1},
			{7, 0, MarshStakato, 0, StakatoShell, 20, 20, 1},
			{7, 0, MarshStakatoWorker, 0, StakatoShell, 20, 30, 1},
			{7, 0, MarshStakatoSoldier, 0, StakatoShell, 20, 50, 1},
			{7, 0, MarshStakatoDrone, 0, StakatoShell, 20, 60, 1},
			{7, 0, ToadLord, 0, ToadLordSac, 10, 50, 1},
			{7, 0, MarshSpider, 0, SpiderThorn, 10, 50, 1}};

	private static boolean QuestProf = true;

	public _221_TestimonyOfProsperity()
	{
		super(221, "_221_TestimonyOfProsperity", "Testimony Of Prosperity");
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Parman)
		{
			if(st.getQuestItemsCount(MarkOfProsperity) != 0 || st.getPlayer().getClassId().getLevel() > 2)
			{
				htmltext = "completed";
			...
			{
				if(!st.getPlayer().getVarB("q221"))
				{
					st.addExpAndSp(599979, 40040);
					st.rollAndGive(57, 108841, 100);
					st.getPlayer().setVar("q221", "1");
				}
