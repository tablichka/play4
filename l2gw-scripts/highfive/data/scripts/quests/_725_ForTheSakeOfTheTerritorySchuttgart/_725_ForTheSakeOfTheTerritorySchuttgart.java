 ...
 */
public class _725_ForTheSakeOfTheTerritorySchuttgart extends ForTheSakeOfTheTerritorySuperclass
{
	...
	{
		super(725, "_725_ForTheSakeOfTheTerritorySchuttgart", "For the Sake of the Territory - Schuttgart");
		addKillId(CATAPULTS);
		addKillId(LEADERS);
		addKillId(SUPPLIES);
