 ...
 */
public class _720_ForTheSakeOfTheTerritoryOren extends ForTheSakeOfTheTerritorySuperclass
{
	...
	{
		super(720, "_720_ForTheSakeOfTheTerritoryOren", "For the Sake of the Territory - Oren");
		addKillId(CATAPULTS);
		addKillId(LEADERS);
		addKillId(SUPPLIES);
