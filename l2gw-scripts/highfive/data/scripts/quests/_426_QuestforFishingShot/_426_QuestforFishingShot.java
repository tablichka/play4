package quests._426_QuestforFishingShot;
...
public class _426_QuestforFishingShot extends Quest
{
	...
	{
		super(426, "_426_QuestforFishingShot", "bypass -h Quest for Fishing Shot");
	...
	public void onKill(L2NpcInstance npc, QuestState st)
	{
		...
		if(Rnd.chance(30))
		{
			if(Arrays.binarySearch(HMOBS, npcId) >= 0)
				st.rollAndGive(SWEET_FLUID, Rnd.get(5) + 1, 100);
			else
				st.rollAndGive(SWEET_FLUID, Rnd.get(3) + 1, 100);
