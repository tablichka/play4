...
public class WizardUseSkill extends WizardBehavior
{
	...
	public int Skill01_Probablity = 10000;
	...
	public int Skill01_Check_Dist = 1;
	public int Skill01_Dist_Min = 300;
	...
	public int Skill01_MainAttack = 1;

	public L2Skill Skill02_ID = null;
	public int Skill02_Probablity = 10000;
	...
	public int Skill02_Check_Dist = 1;
	public int Skill02_Dist_Min = 0;
	public int Skill02_Dist_Max = 300;
	...
	public int Skill02_MainAttack = 1;
	...
	public int Skill03_MainAttack = 0;
	...
	public int Skill04_MainAttack = 0;
	...
	public int Skill05_MainAttack = 0;
	...
	public int Skill06_MainAttack = 0;

	public WizardUseSkill(L2Character actor)
	{
		super(actor);
	}
		...
		if(Skill01_ID != null && Skill01_Probablity > 0)
		{
			if(Skill01_Target == 0 || Skill01_Target == 1)
			{
						...
						&& (Skill01_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill01_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill01_Dist_Max)))
				{
					if(Skill01_Type == 0)
					{
						if(Skill01_MainAttack == 1)
						{
							if(Skill01_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill01_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill01_ID.getId()))
								...
								addAttackDesire(top_desire_target, MovingAttack, 1000);
						}
					...
					{
						if(top_desire_target.getAbnormalLevelBySkill(Skill01_ID) <= 0 && Skill01_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill01_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill01_ID.getId()))
			...
			else if(Skill01_Target == 2 || Skill01_Target == 3)
			{
						...
						&& (Skill01_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill01_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill01_Dist_Max)))
				{
					if(Skill01_Type == 0)
					{
						...
						{
							if(Skill01_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill01_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill01_ID.getId()))
								addUseSkillDesire(_thisActor, Skill01_ID, 0, MovingAttack, (long) Skill01_Desire);
							else
								addAttackDesire(_thisActor, MovingAttack, 1000);
						}
						else if(Skill01_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill01_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill01_ID.getId()))
							addUseSkillDesire(_thisActor, Skill01_ID, 0, MovingAttack, (long) Skill01_Desire);
					}
					...
					{
						if(_thisActor.getAbnormalLevelBySkill(Skill01_ID) <= 0 && Skill01_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill01_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill01_ID.getId()))
		...
		if(Skill02_ID != null && Skill02_Probablity > 0)
		{
			if(Skill02_Target == 0 || Skill02_Target == 1)
			{
						...
						&& (Skill02_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill02_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill02_Dist_Max)))
				{
					...
					{
						if(top_desire_target.getAbnormalLevelBySkill(Skill02_ID) <= 0 && Skill02_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill02_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill02_ID.getId()))
			...
			else if(Skill02_Target == 2 || Skill02_Target == 3)
			{
						...
						&& (Skill02_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill02_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill02_Dist_Max)))
				{
					if(Skill02_Type == 0)
					{
						...
						{
							if(Skill02_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill02_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill02_ID.getId()))
								addUseSkillDesire(_thisActor, Skill02_ID, 0, MovingAttack, (long) Skill02_Desire);
							else
								addAttackDesire(_thisActor, MovingAttack, 1000);
						}
						else if(Skill02_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill02_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill02_ID.getId()))
					...
					{
						if(_thisActor.getAbnormalLevelBySkill(Skill02_ID) <= 0 && Skill02_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill02_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill02_ID.getId()))
		...
		if(Skill03_ID != null && Skill03_Probablity > 0)
		{
			if(Skill03_Target == 0 || Skill03_Target == 1)
			{
						...
						&& (Skill03_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill03_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill03_Dist_Max)))
				{
					...
					{
						if(top_desire_target.getAbnormalLevelBySkill(Skill03_ID) <= 0 && Skill03_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill03_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill03_ID.getId()))
			...
			else if(Skill03_Target == 2 || Skill03_Target == 3)
			{
						...
						&& (Skill03_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill03_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill03_Dist_Max)))
				{
					if(Skill03_Type == 0)
					{
						...
						{
							if(Skill03_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill03_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill03_ID.getId()))
								addUseSkillDesire(_thisActor, Skill03_ID, 0, MovingAttack, (long) Skill03_Desire);
							else
								addAttackDesire(_thisActor, MovingAttack, 1000);
						}
						else if(Skill03_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill03_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill03_ID.getId()))
					...
					{
						if(_thisActor.getAbnormalLevelBySkill(Skill03_ID) <= 0 && Skill03_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill03_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill03_ID.getId()))
			...
			if(Skill04_Target == 0 || Skill04_Target == 1)
			{
						...
						&& (Skill04_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill04_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill04_Dist_Max)))
				{
					if(Skill04_Type == 0)
					{
						...
						{
							if(Skill04_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill04_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill04_ID.getId()))
					...
					{
						if(top_desire_target.getAbnormalLevelBySkill(Skill04_ID) <= 0 && Skill04_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill04_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill04_ID.getId()))
			...
			else if(Skill04_Target == 2 || Skill04_Target == 3)
			{
						...
						&& (Skill04_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill04_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill04_Dist_Max)))
				{
					if(Skill04_Type == 0)
					{
						...
						{
							if(Skill04_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill04_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill04_ID.getId()))
								addUseSkillDesire(_thisActor, Skill04_ID, 0, MovingAttack, (long) Skill04_Desire);
							else
								addAttackDesire(_thisActor, MovingAttack, 1000);
						}
						else if(Skill04_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill04_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill04_ID.getId()))
					...
					{
						if(_thisActor.getAbnormalLevelBySkill(Skill04_ID) <= 0 && Skill04_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill04_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill04_ID.getId()))
			...
			if(Skill05_Target == 0 || Skill05_Target == 1)
			{
						...
						&& (Skill05_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill05_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill05_Dist_Max)))
				{
					if(Skill05_Type == 0)
					{
						...
						{
							if(Skill05_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill05_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill05_ID.getId()))
								addUseSkillDesire(top_desire_target, Skill05_ID, 0, MovingAttack, (long) Skill05_Desire);
							else
								addAttackDesire(top_desire_target, MovingAttack, 1000);
						}
						else if(Skill05_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill05_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill05_ID.getId()))
							addUseSkillDesire(top_desire_target, Skill05_ID, 0, MovingAttack, (long) Skill05_Desire);
					}
					else if(Skill05_Type == 1)
					{
						if(top_desire_target.getAbnormalLevelBySkill(Skill05_ID) <= 0 && Skill05_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill05_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill05_ID.getId()))
			...
			else if(Skill05_Target == 2 || Skill05_Target == 3)
			{
						...
						&& (Skill05_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill05_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill05_Dist_Max)))
				{
					if(Skill05_Type == 0)
					{
						...
						{
							if(Skill05_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill05_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill05_ID.getId()))
								addUseSkillDesire(_thisActor, Skill05_ID, 0, MovingAttack, (long) Skill05_Desire);
							else
								addAttackDesire(_thisActor, MovingAttack, 1000);
						}
						else if(Skill05_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill05_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill05_ID.getId()))
					...
					{
						if(_thisActor.getAbnormalLevelBySkill(Skill05_ID) <= 0 && Skill05_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill05_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill05_ID.getId()))
			...
			if(Skill06_Target == 0 || Skill06_Target == 1)
			{
						...
						&& (Skill06_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill06_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill06_Dist_Max)))
				{
					if(Skill06_Type == 0)
					{
						...
						{
							if(Skill06_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill06_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill06_ID.getId()))
								addUseSkillDesire(top_desire_target, Skill06_ID, 0, MovingAttack, (long) Skill06_Desire);
							else
								addAttackDesire(top_desire_target, MovingAttack, 1000);
						}
						else if(Skill06_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill06_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill06_ID.getId()))
							addUseSkillDesire(top_desire_target, Skill06_ID, 0, MovingAttack, (long) Skill06_Desire);
					}
					else if(Skill06_Type == 1)
					{
						if(top_desire_target.getAbnormalLevelBySkill(Skill06_ID) <= 0 && Skill06_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill06_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill06_ID.getId()))
			...
			else if(Skill06_Target == 2 || Skill06_Target == 3)
			{
						...
						&& (Skill06_Check_Dist == 0 || !_thisActor.isInRange(top_desire_target, Skill06_Dist_Min) && _thisActor.isInRange(top_desire_target, Skill06_Dist_Max)))
				{
					if(Skill06_Type == 0)
					{
						...
						{
							if(Skill06_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill06_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill06_ID.getId()))
								addUseSkillDesire(_thisActor, Skill06_ID, 0, MovingAttack, (long) Skill06_Desire);
							else
								addAttackDesire(_thisActor, MovingAttack, 1000);
						}
						else if(Skill06_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill06_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill06_ID.getId()))
					...
					{
						if(_thisActor.getAbnormalLevelBySkill(Skill06_ID) <= 0 && Skill06_ID.getMpConsume() < _thisActor.getCurrentMp() && Skill06_ID.getHpConsume() < _thisActor.getCurrentHp() && !_thisActor.isSkillDisabled(Skill06_ID.getId()))
