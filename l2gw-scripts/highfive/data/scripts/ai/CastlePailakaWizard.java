...
/**
 * @author rage
 * @date 02.12.2010 17:08:43
 */
public class CastlePailakaWizard extends CastlePailakaNpc
{
	public CastlePailakaWizard(L2Character actor)
	{
		super(actor);
	}
	...
	protected void onEvtScriptEvent(int eventId, Object arg1, Object arg2)
	{
		if(eventId == KNIGHT_ATTACKED)
		{
			...
			if(_thisActor.isInRange(cha, 750))
	...
	protected boolean createNewTask()
	{
		...
		if(_thisActor.isInRange(_temp_attack_target, 750) && Skill01 != null && Skill01.getMpConsume() < _thisActor.getCurrentMp() && !_thisActor.isSkillDisabled(Skill01.getId()))
		{
		...
		else if(_thisActor.isInRange(_temp_attack_target, 150) && Skill02 != null && Skill02.getMpConsume() < _thisActor.getCurrentMp() && !_thisActor.isSkillDisabled(Skill02.getId()))
		{
