...
import ai.base.WarriorAgCasting3skillMagical;
 ...
 * @date: 15.09.11 17:09
 */
public class AiBoss05ValeMasterB extends WarriorAgCasting3skillMagical
{
	...
	public AiBoss05ValeMasterB(L2Character actor)
	{
		super(actor);
		DDMagic = SkillTable.getInstance().getInfo(267845637);
		CancelMagic = SkillTable.getInstance().getInfo(268304385);
	}
