...
/**
 * @author rage
 * @date 09.12.2010 16:31:44
 */
public class ZakenBoss extends DefaultAI
{
	...
	public ZakenBoss(L2Character actor)
	{
		super(actor);
	}
	...
	protected void onEvtScriptEvent(int eventId, Object arg1, Object arg2)
	{
		if(eventId == 2124002)
		{
			...
			if(_thisActor.i_ai0 > 3)
			{
				...
				inst.addSpawn(29026, GeoEngine.findPointToStay(_thisActor.getX(), _thisActor.getY(), _thisActor.getZ(), 60, 150, _thisActor.getReflection()), 0);
				inst.addSpawn(29026, GeoEngine.findPointToStay(_thisActor.getX(), _thisActor.getY(), _thisActor.getZ(), 60, 150, _thisActor.getReflection()), 0);
				inst.addSpawn(29024, GeoEngine.findPointToStay(_thisActor.getX(), _thisActor.getY(), _thisActor.getZ(), 60, 150, _thisActor.getReflection()), 0);
				inst.addSpawn(29024, GeoEngine.findPointToStay(_thisActor.getX(), _thisActor.getY(), _thisActor.getZ(), 60, 150, _thisActor.getReflection()), 0);
		...
		if(player != null)
		{
			...
			if(party != null)
			{
				...
				if(cc != null)
					...
					{
						member.sendPacket(new ExSendUIEvent(member.getObjectId(), false));
						if(time < 300000)
							member.addExpAndSp((long)(1046865 * Config.RATE_XP), (long)(50000 * Config.RATE_SP));
						else if(time < 600000 && Rnd.chance(20))
							member.addExpAndSp((long)((837492 + Rnd.get(1000)) * Config.RATE_XP), (long)(30000 * Config.RATE_SP));
					}
				else
