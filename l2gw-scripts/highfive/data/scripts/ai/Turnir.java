			...
			if(!wait)
				switch(current_point)
				{
					...
					case 0:
						...
						Functions.npcSay(_thisActor, Say2C.ALL, "Создайте команду, запишитесь на турнир!!!!");//TODO: Вынести в CustomMessage.
						wait = true;
						return true;

					case 2:
						wait_timeout = System.currentTimeMillis() + 300000;
						Functions.npcSay(_thisActor, Say2C.ALL, "Только сильнейшие получат уважение окружающих  !!!!");//TODO: Вынести в CustomMessage.
						wait = true;
						return true;

					case 4:
						wait_timeout = System.currentTimeMillis() + 300000;
						Functions.npcSay(_thisActor, Say2C.ALL, "Не мешкайте, летите в Гиран, записывайтесь !!!");//TODO: Вынести в CustomMessage.
						wait = true;
						return true;
					case 6:
						wait_timeout = System.currentTimeMillis() + 300000;
						Functions.npcSay(_thisActor, Say2C.ALL, "Победа зависит только от вас !!!!");//TODO: Вынести в CustomMessage.
						wait = true;
						return true;
					case 8:
						wait_timeout = System.currentTimeMillis() + 300000;
						Functions.npcSay(_thisActor, Say2C.ALL, "В Гиран летите, только мне можно подать заявку на участие !!!!");//TODO: Вынести в CustomMessage.
						wait = true;
						return true;
				}
