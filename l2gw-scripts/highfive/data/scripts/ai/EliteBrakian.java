 ...
 * @date: 12.12.11 16:46
 */
public class EliteBrakian extends AiASeedEliteMonster
{
	public L2Skill SpecialSkill01_ID = SkillTable.getInstance().getInfo(418185217);

	public EliteBrakian(L2Character actor)
	{
		super(actor);
		Skill01_ID = SkillTable.getInstance().getInfo(418381826);
		Skill01_Probability = 30;
		Skill01_Target_Type = 0;
		Skill02_ID = SkillTable.getInstance().getInfo(418447361);
