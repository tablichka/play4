 ...
 * @date: 06.10.11 19:11
 */
public class Ssq2TombGuardian2 extends WarriorUseSkill
{
	public int SLAVE_SPAWN_POS1_X = 55672;
	public int SLAVE_SPAWN_POS1_Y = -252099;
	public int SLAVE_SPAWN_POS1_Z = -6751;
	public int SLAVE_SPAWN_POS2_X = 55810;
	public int SLAVE_SPAWN_POS2_Y = -252262;
	public int SLAVE_SPAWN_POS2_Z = -6752;
	public int SLAVE_SPAWN_POS3_X = 55824;
	public int SLAVE_SPAWN_POS3_Y = -252112;
	public int SLAVE_SPAWN_POS3_Z = -6752;
	public int SLAVE_SPAWN_POS4_X = 55669;
	public int SLAVE_SPAWN_POS4_Y = -252227;
	public int SLAVE_SPAWN_POS4_Z = -6752;

	public Ssq2TombGuardian2(L2Character actor)
	{
		super(actor);
		IsAggressive = 1;
	}
	...
	{
		super.onEvtSpawn();
		//ServerVariables.set("GM_" + 80401, _thisActor.id);
		addTimer(2202, 5000);
		_thisActor.i_ai0 = 0;
		_thisActor.i_ai1 = 0;
	}
