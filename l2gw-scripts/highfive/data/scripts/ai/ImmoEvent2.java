 ...
 * @date: 19.12.11 13:52
 */
public class ImmoEvent2 extends ImmoSbossBasic
{
	public ImmoEvent2(L2Character actor)
	{
		super(actor);
	...
	protected void onEvtTimer(int timerId, Object arg1, Object arg2)
	{
		if(timerId == TM_ATTACK_COOLDOWN)
		{
			...
			if(c0 != null && _thisActor.getHate(c0) > 0)
			{
				...
				{
					if(Skill02_ID.getIndex() == 386531329 && _thisActor.getLoc().distance3D(c0.getLoc()) <= 300)
					{
