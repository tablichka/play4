 ...
 * @date: 06.10.11 19:13
 */
public class Ssq2TombGuardian3 extends WarriorUseSkill
{
	public int SLAVE_SPAWN_POS1_X = 56480;
	public int SLAVE_SPAWN_POS1_Y = -252833;
	public int SLAVE_SPAWN_POS1_Z = -6751;
	public int SLAVE_SPAWN_POS2_X = 56481;
	public int SLAVE_SPAWN_POS2_Y = -252725;
	public int SLAVE_SPAWN_POS2_Z = -6752;
	public int SLAVE_SPAWN_POS3_X = 56368;
	public int SLAVE_SPAWN_POS3_Y = -252787;
	public int SLAVE_SPAWN_POS3_Z = -6752;
	public int SLAVE_SPAWN_POS4_X = 56368;
	public int SLAVE_SPAWN_POS4_Y = -252669;
	public int SLAVE_SPAWN_POS4_Z = -6752;

	public Ssq2TombGuardian3(L2Character actor)
	{
		super(actor);
		IsAggressive = 1;
	}
	...
	{
		super.onEvtSpawn();
		//ServerVariables.set("GM_" + 80402, _thisActor.id);
		addTimer(2202, 5000);
		_thisActor.i_ai0 = 0;
		_thisActor.i_ai1 = 0;
	}
