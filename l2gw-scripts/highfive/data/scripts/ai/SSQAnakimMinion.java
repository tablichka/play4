...
/**
 * @author rage
 * @date 27.11.2010 16:16:28
 */
public class SSQAnakimMinion extends DefaultAI
{
	public SSQAnakimMinion(L2Character actor)
	{
		super(actor);
	}
	...
	protected void onEvtTimer(int timerId, Object arg1, Object arg2)
	{
		if(timerId == 1000)
		{
			broadcastScriptEvent(40, _thisActor, null, 3000);
			addTimer(1000, 5000);
		}
		else
