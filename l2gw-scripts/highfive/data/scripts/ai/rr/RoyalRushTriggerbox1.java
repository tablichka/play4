...
{
	public String room_event_1 = "1rd_type1_a";
	public String room_event_2 = "1rd_type2_a";
	public String room_event_3 = "1rd_type3_a";

	public RoyalRushTriggerbox1(L2Character actor)
	{
		super(actor);
	}
	...
	public boolean onTalk(L2Player talker)
	{
		...
		switch(i0)
		{
			...
			case 1:
				...
				break;
			case 2:
				maker0 = SpawnTable.getInstance().getNpcMaker(room_event_3);
				if( maker0 != null )
				{
					maker0.onScriptEvent(1000, 0, 0);
					maker0.onScriptEvent(1001, 0, 0);
