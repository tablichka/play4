...
import ai.base.WarriorAggressivePhysicalspecial;
 ...
 * @date: 15.09.11 17:25
 */
public class AiBoss05PiratesZombieB extends WarriorAggressivePhysicalspecial
{
	...
	public AiBoss05PiratesZombieB(L2Character actor)
	{
		super(actor);
		PhysicalSpecial = SkillTable.getInstance().getInfo(266534917);
	}
